...
import Netspan.NBI_15_2.Lte.ClockSources;
...
import Netspan.NBI_15_2.Software.NodeSoftwareStatus;
import Netspan.NBI_15_2.Software.SoftwareStatusGetWs;
		...
		if (result.getErrorCode() != Netspan.NBI_15_2.Software.ErrorCodes.OK) {
			...
			for(int i = 0; i < numberOfSoftwareStatus; i++){
				...
				if((numberOfSoftwareStatus == 1) || (imageType == null) || imageType.value().equals(softwareStatus.getImageType())){
					...
					newsoftwareStatus.ImageType = softwareStatus.getImageType();
