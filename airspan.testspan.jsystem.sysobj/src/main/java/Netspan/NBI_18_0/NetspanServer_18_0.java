...
import Netspan.NBI_18_0.SoapHelper;
import Netspan.NBI_18_0.FaultManagement.Alarm;
import Netspan.NBI_18_0.FaultManagement.AlarmActionResult;
import Netspan.NBI_18_0.FaultManagement.AlarmResultList;
import Netspan.NBI_18_0.FaultManagement.Event;
import Netspan.NBI_18_0.FaultManagement.EventResultList;
import Netspan.NBI_18_0.Inventory.DiscoveryTaskActionResult;
import Netspan.NBI_18_0.Inventory.NodeActionResult;
import Netspan.NBI_18_0.Inventory.NodeDetailGetResult;
import Netspan.NBI_18_0.Inventory.NodeManagementMode;
import Netspan.NBI_18_0.Inventory.NodeProvisioningGetResult;
import Netspan.NBI_18_0.Inventory.NodeProvisioningGetWs;
import Netspan.NBI_18_0.Inventory.WsResponse;
import Netspan.NBI_18_0.Lte.AddlSpectrumEmissions;
import Netspan.NBI_18_0.Lte.AirSonWs;
import Netspan.NBI_18_0.Lte.AnrFreq;
import Netspan.NBI_18_0.Lte.AnrFreqListContainer;
import Netspan.NBI_18_0.Lte.AuPnpDetailWs;
import Netspan.NBI_18_0.Lte.CellToUseValues;
import Netspan.NBI_18_0.Lte.ClockContainer;
import Netspan.NBI_18_0.Lte.ClockSource;
import Netspan.NBI_18_0.Lte.Duplex;
import Netspan.NBI_18_0.Lte.DuplexModeTypes;
import Netspan.NBI_18_0.Lte.EaidsParams;
import Netspan.NBI_18_0.Lte.Enb3RdParty;
import Netspan.NBI_18_0.Lte.EnbAdvancedProfile;
import Netspan.NBI_18_0.Lte.EnbCellAdvancedProfile;
import Netspan.NBI_18_0.Lte.EnbDetailsGet;
import Netspan.NBI_18_0.Lte.EnbDetailsGetPnp;
import Netspan.NBI_18_0.Lte.EnbManagementProfile;
import Netspan.NBI_18_0.Lte.EnbMobilityProfile;
import Netspan.NBI_18_0.Lte.EnbMultiCellProfile;
import Netspan.NBI_18_0.Lte.EnbNeighbourProfile;
import Netspan.NBI_18_0.Lte.EnbNetworkProfile;
import Netspan.NBI_18_0.Lte.EnbPnpConfig;
import Netspan.NBI_18_0.Lte.EnbRadioProfile;
import Netspan.NBI_18_0.Lte.EnbSecurityProfile;
import Netspan.NBI_18_0.Lte.EnbSonProfile;
import Netspan.NBI_18_0.Lte.EnbSyncProfile;
import Netspan.NBI_18_0.Lte.EnbTypesWs;
import Netspan.NBI_18_0.Lte.EtwsModes;
import Netspan.NBI_18_0.Lte.EtwsWs;
import Netspan.NBI_18_0.Lte.Lte3RdPartyGetResult;
import Netspan.NBI_18_0.Lte.Lte3RdPartyResponse;
import Netspan.NBI_18_0.Lte.LteAddNeighbourForCellWs;
import Netspan.NBI_18_0.Lte.LteAddNeighbourWs;
import Netspan.NBI_18_0.Lte.LteCSonEntryWs;
import Netspan.NBI_18_0.Lte.LteCellGetWs;
import Netspan.NBI_18_0.Lte.LteCellSetWs;
import Netspan.NBI_18_0.Lte.LteEnbConfigGetResult;
import Netspan.NBI_18_0.Lte.LteEnbDetailsSetWs;
import Netspan.NBI_18_0.Lte.LteEnbDetailsSetWsPnp;
import Netspan.NBI_18_0.Lte.LteNeighbourResponse;
import Netspan.NBI_18_0.Lte.LteNetworkProfileGetResult;
import Netspan.NBI_18_0.Lte.LtePlmnEntryWs;
import Netspan.NBI_18_0.Lte.LtePnpConfigGetResult;
import Netspan.NBI_18_0.Lte.LteRadioProfileGetResult;
import Netspan.NBI_18_0.Lte.LteS1EntryWs;
import Netspan.NBI_18_0.Lte.LteSecurityProfileGetResult;
import Netspan.NBI_18_0.Lte.LteSonCSonWs;
import Netspan.NBI_18_0.Lte.LteSyncProfileGetResult;
import Netspan.NBI_18_0.Lte.LteSyncProfileResult;
import Netspan.NBI_18_0.Lte.LteSystemDefaultProfile;
import Netspan.NBI_18_0.Lte.MaintenanceWindowConfigurationWs;
import Netspan.NBI_18_0.Lte.MobilityConnectedModeFreq;
import Netspan.NBI_18_0.Lte.MobilityConnectedModeInterDefaultContainer;
import Netspan.NBI_18_0.Lte.MobilityConnectedModeIntraFrequencyListContainer;
import Netspan.NBI_18_0.Lte.MobilityConnectedModeThresholdBased;
import Netspan.NBI_18_0.Lte.MobilityConnectedModeThresholdBasedListContainer;
import Netspan.NBI_18_0.Lte.MultiCellProfileGetResult;
import Netspan.NBI_18_0.Lte.MultiCellProfileResult;
import Netspan.NBI_18_0.Lte.NameResult;
import Netspan.NBI_18_0.Lte.NeighbourHomeEnbBandConfig;
import Netspan.NBI_18_0.Lte.NeighbourHomeEnbBandListContainer;
import Netspan.NBI_18_0.Lte.NeighbourHomeEnbDefaultConfig;
import Netspan.NBI_18_0.Lte.NeighbourHomeEnbEarfcnConfig;
import Netspan.NBI_18_0.Lte.NeighbourHomeEnbEarfcnListContainer;
import Netspan.NBI_18_0.Lte.NeighbourHomeEnbPciWs;
import Netspan.NBI_18_0.Lte.NeighbourNrtBandConfig;
import Netspan.NBI_18_0.Lte.NeighbourNrtBandListContainer;
import Netspan.NBI_18_0.Lte.NeighbourNrtDefaultConfig;
import Netspan.NBI_18_0.Lte.NeighbourNrtEarfcnConfig;
import Netspan.NBI_18_0.Lte.NeighbourNrtEarfcnListContainer;
import Netspan.NBI_18_0.Lte.NeighbourNrtPciWs;
import Netspan.NBI_18_0.Lte.NlmIntraFreqScan;
import Netspan.NBI_18_0.Lte.NlmIntraFreqScanListContainer;
import Netspan.NBI_18_0.Lte.NodeListResult;
import Netspan.NBI_18_0.Lte.NodeProperty;
import Netspan.NBI_18_0.Lte.NodeResult;
import Netspan.NBI_18_0.Lte.NodeSimple;
import Netspan.NBI_18_0.Lte.ObjectFactory;
import Netspan.NBI_18_0.Lte.PciConflictHandlingValues;
import Netspan.NBI_18_0.Lte.PciRange;
import Netspan.NBI_18_0.Lte.PciRangeListContainer;
import Netspan.NBI_18_0.Lte.PlmnListContainer;
import Netspan.NBI_18_0.Lte.PnpConfigCreate;
import Netspan.NBI_18_0.Lte.PnpDetailWs;
import Netspan.NBI_18_0.Lte.PnpHardwareTypes;
import Netspan.NBI_18_0.Lte.ProfileResponse;
import Netspan.NBI_18_0.Lte.RelayEnodeBConfigGetResult;
import Netspan.NBI_18_0.Lte.ResourceManagementTypes;
import Netspan.NBI_18_0.Lte.RfSubframe;
import Netspan.NBI_18_0.Lte.RsiRange;
import Netspan.NBI_18_0.Lte.RsiRangeListContainer;
import Netspan.NBI_18_0.Lte.S1ListContainer;
import Netspan.NBI_18_0.Lte.SfrThresholdTypes;
import Netspan.NBI_18_0.Lte.SnmpDetailSetWs;
import Netspan.NBI_18_0.Lte.SnmpDetailWs;
import Netspan.NBI_18_0.Lte.TddFrameConfigurationsSupported;
import Netspan.NBI_18_0.Lte.TimeZones;
import Netspan.NBI_18_0.Server.FileServerProtocolType;
import Netspan.NBI_18_0.Server.FileServerResponse;
import Netspan.NBI_18_0.Server.FileServerWs;
import Netspan.NBI_18_0.Server.NmsInfoResponse;
import Netspan.NBI_18_0.Software.NodeSoftwareStatus;
import Netspan.NBI_18_0.Software.NodeSoftwareStatusResult;
import Netspan.NBI_18_0.Software.SoftwareStatusGetWs;
import Netspan.NBI_18_0.Software.SwConfigSetWs;
import Netspan.NBI_18_0.Software.SwFileInfoWs;
import Netspan.NBI_18_0.Software.SwImageWs;
import Netspan.NBI_18_0.Software.SwServerWs;
import Netspan.NBI_18_0.Status.LteAnrStatusWs;
import Netspan.NBI_18_0.Status.LteBackhaulIfGetResult;
import Netspan.NBI_18_0.Status.LteBackhaulWs;
import Netspan.NBI_18_0.Status.LteIpThroughputCellWs;
import Netspan.NBI_18_0.Status.LteIpThroughputGetResult;
import Netspan.NBI_18_0.Status.LteIpThroughputQciWs;
import Netspan.NBI_18_0.Status.LteNetworkElementGetResult;
import Netspan.NBI_18_0.Status.LteNetworkElementStatusWs;
import Netspan.NBI_18_0.Status.LtePciStatusWs;
import Netspan.NBI_18_0.Status.LteRfGetResult;
import Netspan.NBI_18_0.Status.LteRfStatusWs;
import Netspan.NBI_18_0.Status.LteRsiStatusWs;
import Netspan.NBI_18_0.Status.LteSonAnrGetResult;
import Netspan.NBI_18_0.Status.LteSonPciGetResult;
import Netspan.NBI_18_0.Status.LteSonRsiGetResult;
import Netspan.NBI_18_0.Status.LteUeGetResult;
import Netspan.NBI_18_0.Status.NodeGpsGetResult;
import Netspan.NBI_18_0.Status.NodePtpGetResult;
import Netspan.NBI_18_0.Status.NodeSoftwareGetResult;
...
public class NetspanServer_18_0 extends NetspanServer implements Netspan_18_0_abilities{
	
    public SoapHelper soapHelper_18_0;
    private static final String USERNAME = "wsadmin";
	private static final String PASSWORD = "password";
	private static final Netspan.NBI_18_0.Lte.Credentials credentialsLte = new Netspan.NBI_18_0.Lte.Credentials();
	private static final Netspan.NBI_18_0.Inventory.Credentials credentialsInventory = new Netspan.NBI_18_0.Inventory.Credentials();
	private static final Netspan.NBI_18_0.FaultManagement.Credentials credentialsFaultManagement = new Netspan.NBI_18_0.FaultManagement.Credentials();
	private static final Netspan.NBI_18_0.Statistics.Credentials credentialsStatistics = new Netspan.NBI_18_0.Statistics.Credentials();
	private static final Netspan.NBI_18_0.Status.Credentials credentialsStatus = new Netspan.NBI_18_0.Status.Credentials();
	private static final Netspan.NBI_18_0.Server.Credentials credentialsServer = new Netspan.NBI_18_0.Server.Credentials();
	private static final Netspan.NBI_18_0.Backhaul.Credentials credentialsBackhaul = new Netspan.NBI_18_0.Backhaul.Credentials();
	private static final Netspan.NBI_18_0.Software.Credentials credentialsSoftware = new Netspan.NBI_18_0.Software.Credentials();

	@Override
	public void init() throws Exception {
		if (NBI_VERSION == null) {
			NBI_VERSION = NBIVersion.NBI_18_0;
		}
		super.init();
	}
    ...
    public void initSoapHelper() throws Exception{
    	this.soapHelper_18_0 = new SoapHelper(getHostname());
    ...
    protected void populateNodeNames() {
        ...
        Netspan.NBI_18_0.Inventory.NodeListResult result = soapHelper_18_0
            .getInventorySoap().nodeList(null,credentialsInventory);

        for (int nodeIndex = 0; nodeIndex < result.getNode().size(); nodeIndex++) {
            Netspan.NBI_18_0.Inventory.NodeSimple node = result.getNode().get(nodeIndex);
            nodeNames.put(node.getNodeId(), node.getName());
        }
        soapHelper_18_0.endInventorySoap();
    }
    ...
    public RadioParameters radioProfileGet(EnodeB enb) throws Exception {
        ...
        netspanResult = soapHelper_18_0.getLteSoap().radioProfileGet(enbList,null,null,
            credentialsLte);
        radioParam = parseRadioProfile(netspanResult);
        soapHelper_18_0.endLteSoap();
        return radioParam;
    }
    ...
    private EnbDetailsGet getNodeConfig(EnodeB enb) {
        ...
        if (isPnpNode(enb.getNetspanName())) {
            ...
            try {
                result = soapHelper_18_0.getLteSoap().pnpConfigGet(nodeListName,null, credentialsLte);
            } catch (Exception e) {
            ...
            if (result.getErrorCode() != Netspan.NBI_18_0.Lte.ErrorCodes.OK) {
        ...
        try {
            result = soapHelper_18_0.getLteSoap().enbConfigGet(nodeListName,null, credentialsLte);
    ...
    public String getNetspanVersion() {
        if (netspanVersion == null) {
            NmsInfoResponse nms;
            try {
                nms = soapHelper_18_0.getServerSoap().nmsInfoGet(credentialsServer);
                if (nms.getErrorCode() != Netspan.NBI_18_0.Server.ErrorCodes.OK) {
    ...
    public boolean deleteNeighbor(EnodeB enodeB, EnodeB neighbor) {
        try {
            Netspan.NBI_18_0.Lte.LteNeighbourResponse result = soapHelper_18_0
    ...
    public boolean deleteAllNeighbors(EnodeB enodeB) {
        try {
            if (verifyNoNeighbors(enodeB))
                return true;
            LteNeighbourResponse result = soapHelper_18_0.getLteSoap()
        ...
        try {
            switch (profileType) {
                case EnodeB_Advanced_Profile:
                    response = soapHelper_18_0.getLteSoap().cellAdvancedConfigProfileDelete(nameList,
                        credentialsLte);
                    break;
                ...
                case Management_Profile:
                    response = soapHelper_18_0.getLteSoap().managementProfileDelete(nameList,
                        credentialsLte);
                    break;
                case Mobility_Profile:
                    response = soapHelper_18_0.getLteSoap().mobilityProfileDelete(nameList,
                        credentialsLte);
                    break;
                case Network_Profile:
                    response = soapHelper_18_0.getLteSoap().networkProfileDelete(nameList,
                        credentialsLte);
                    break;
                case Radio_Profile:
                    response = soapHelper_18_0.getLteSoap().radioProfileDelete(nameList, credentialsLte);
                    break;
                case Security_Profile:
                    response = soapHelper_18_0.getLteSoap().securityProfileDelete(nameList,
                        credentialsLte);
                    break;
                case Son_Profile:
                    response = soapHelper_18_0.getLteSoap().sonProfileDelete(nameList, credentialsLte);
                    break;
                case Sync_Profile:
                    response = soapHelper_18_0.getLteSoap().syncProfileDelete(nameList, credentialsLte);
                    break;
                case MultiCell_Profile:
                    response = soapHelper_18_0.getLteSoap().multiCellProfileDelete(nameList,
                        credentialsLte);
                    break;
                case Neighbour_Management_Profile:
                	response = soapHelper_18_0.getLteSoap().neighbourProfileDelete(nameList, credentialsLte);
                	break;
                default:
                    report.report("deleteEnbProfile get EnbProfiles type not exist: " + profileType, Reporter.WARNING);
                    return false;
            }
            if (response.getErrorCode() != Netspan.NBI_18_0.Lte.ErrorCodes.OK) {
    ...
    public boolean isProfileExists(String name, EnbProfiles profileType) {
        ...
        nameList.add(name);
        Netspan.NBI_18_0.Lte.WsResponse response = null;
        try {
            switch (profileType) {
                case System_Default_Profile:
                    response = soapHelper_18_0.getLteSoap()
                ...
                case Cell_Advanced_Profile:
                    ...
                    break;
                case Management_Profile:
                    response = soapHelper_18_0.getLteSoap().managementProfileGet(nameList,null,null,
                        credentialsLte);
                    break;
                case Mobility_Profile:
                    response = soapHelper_18_0.getLteSoap().mobilityProfileGet(nameList,null,null,
                        credentialsLte);
                    break;
                case Network_Profile:
                    response = soapHelper_18_0.getLteSoap().networkProfileGet(nameList,null,null,
                        credentialsLte);
                    break;
                case Radio_Profile:
                    response = soapHelper_18_0.getLteSoap().radioProfileGet(nameList,null,null,
                        credentialsLte);
                    break;
                case Security_Profile:
                    response = soapHelper_18_0.getLteSoap().securityProfileGet(nameList,null,null,
                        credentialsLte);
                    break;
                case Son_Profile:
                    response = soapHelper_18_0.getLteSoap().sonProfileGet(nameList,null,null,
                        credentialsLte);
                    break;
                case Sync_Profile:
                    response = soapHelper_18_0.getLteSoap().syncProfileGet(nameList,null,null,
                        credentialsLte);
                    break;
                case MultiCell_Profile:
                    response = soapHelper_18_0.getLteSoap().multiCellProfileGet(nameList,null,null,
                        credentialsLte);
                    break;
                case Neighbour_Management_Profile:
                	response = soapHelper_18_0.getLteSoap().neighbourProfileGet(nameList, null,null,
    						credentialsLte);
                	break;
                default:
                    report.report("isProfileExists get error EnbProfiles type: " + profileType, Reporter.WARNING);
            }
            return response.getErrorCode() == Netspan.NBI_18_0.Lte.ErrorCodes.OK;
    ...
    private boolean enbSetContent(EnodeB node, NodeProperty nodeProperty, LteEnbDetailsSetWs enbConfigSet,
		...
		try {
			Netspan.NBI_18_0.Lte.NodeActionResult result = soapHelper_18_0
			.getLteSoap()
    ...
    public boolean cloneRadioProfile(EnodeB node, String cloneFromName, RadioParameters radioParams) {
        ...
        try {
            ProfileResponse cloneResult = soapHelper_18_0.getLteSoap()
            ...
            if (cloneResult == null) {
                ...
                result = false;
            } else if (cloneResult.getErrorCode() == Netspan.NBI_18_0.Lte.ErrorCodes.OK) {
    ...
    public boolean updateRadioProfile(EnodeB node, RadioParameters radioParams) {
        ...
        try {
            ProfileResponse cloneResult = soapHelper_18_0.getLteSoap().radioProfileUpdate(profileName,
    ...
    public boolean cloneSonProfile(EnodeB node, String cloneFromName, SonParameters sonParmas) {
    	try {
			...
			ProfileResponse cloneResult = soapHelper_18_0.getLteSoap().sonProfileClone(cloneFromName,
    ...
    public boolean cloneSyncProfile(EnodeB node, String cloneFromName, SyncParameters syncParams) {
		...
		try {
			ProfileResponse cloneResult = (ProfileResponse) soapHelper_18_0.getLteSoap().syncProfileClone(cloneFromName,
    ...
    public PrimaryClockSourceEnum getPrimaryClockSource(EnodeB node) {
		...
		try{
			LteSyncProfileGetResult syncProfile = (LteSyncProfileGetResult) soapHelper_18_0.getLteSoap().syncProfileGet(nameList, cat ,null, credentialsLte);
    ...
    public boolean cloneNetworkProfile(EnodeB node, String cloneFromName, NetworkParameters networkParams)
		...
		ProfileResponse cloneResult = soapHelper_18_0.getLteSoap().networkProfileClone(cloneFromName,
    ...
    public boolean cloneSecurityProfile(EnodeB node, String cloneFromName, SecurityParameters securityParams)
        ...
        try {
            currentSecurityProfile = soapHelper_18_0.getLteSoap()
                .securityProfileGet(profilesList,null,null, credentialsLte);
            if (currentSecurityProfile.getErrorCode() != Netspan.NBI_18_0.Lte.ErrorCodes.OK) {
        ...
        try {
            ...
            boolean result = false;
            if (cloneResult.getErrorCode() != Netspan.NBI_18_0.Lte.ErrorCodes.OK) {
    ...
    public boolean convertToPnPConfig(EnodeB node) {
    	try {
			Netspan.NBI_18_0.Lte.NodeActionResult result = null;
			...
			if (isRelayEnodeb(node.getNetspanName())) {
				...
				result = soapHelper_18_0.getLteSoap().relayEnbPnpConfigConvertFromNode(
				...
				result = soapHelper_18_0.getLteSoap().pnpConfigConvertFromNode(node.getNetspanName(),
			...
			if (result == null) {
				...
				return false;
			} else if (result.getErrorCode() == Netspan.NBI_18_0.Lte.ErrorCodes.OK) {
    ...
    public boolean removeNode(String nodeName) {
        ...
        try {
            ...
            NodeActionResult result = soapHelper_18_0.getInventorySoap().nodeDelete(nodeList, null,
            ...
            if (result.getErrorCode() != Netspan.NBI_18_0.Inventory.ErrorCodes.OK) {
    ...
    public boolean removeDiscoveryTask(String nodeName) {
        ...
        try {
            ...
            DiscoveryTaskActionResult result = soapHelper_18_0.getInventorySoap()
    ...
    public boolean setManagedMode(String nodeName, NodeManagementModes managedMode) {
        Netspan.NBI_18_0.Inventory.ObjectFactory factory = new Netspan.NBI_18_0.Inventory.ObjectFactory();
        ...
        nodeList.add(node);
        try {
            NodeActionResult result = soapHelper_18_0.getInventorySoap()
    ...
    private boolean createDiscoveryTaskV2(EnodeB enodeB, String pswrdRead, String pswrdWrite) {
        ...
        WsResponse result;
        try {
            result = soapHelper_18_0.getInventorySoap().discoveryTaskAddSnmpV2(enodeB.getNetspanName(),
    ...
    private boolean updatePnPConfig(EnodeB enodeB, EnbPnpConfig pnpConfig) {
        ...
        Netspan.NBI_18_0.Lte.NodeActionResult result;
        LteEnbDetailsSetWsPnp snmpDetailWs = new LteEnbDetailsSetWsPnp();
        try {
            result = soapHelper_18_0.getLteSoap().pnpConfigUpdate(
            ...
            return result.getErrorCode() == Netspan.NBI_18_0.Lte.ErrorCodes.OK;
        } catch (Exception e) {
            e.printStackTrace();
    ...
    protected EnbPnpConfig getPnpNode(String nodeName) {
        ...
        if (isPnPNodeExists(nodeName)) {
            try {
                ...
                LtePnpConfigGetResult result = soapHelper_18_0.getLteSoap()
    ...
    private boolean isPnPNodeExists(String pnpNodeName) {
        ...
        try {
            result = soapHelper_18_0.getLteSoap().pnpConfigList(credentialsLte);
            GeneralUtils
    ...
    private boolean createPnpNode(PnpConfigCreate pnpConfigCreate) {
        ...
        try {
            result = soapHelper_18_0.getLteSoap().pnpConfigCreate(null,
    ...
    private boolean setNodeConfig(EnodeB enodeB, LteEnbDetailsSetWs netspanConfig) {
        try {
            ...
            if (result.getErrorCode() == Netspan.NBI_18_0.Lte.ErrorCodes.OK)
                ...
                for (Netspan.NBI_18_0.Lte.NodeResult node : result.getNode()) {
                    if (node.getNodeResultCode() == Netspan.NBI_18_0.Lte.NodeResultValues.NODE_ERROR) {
    ...
    public boolean Create3rdParty(String name, String ipAddress, int physicalLayerCellGroup, int physicalLayerIdentity,
        ...
        try {
            Lte3RdPartyResponse result = soapHelper_18_0.getLteSoap()
    ...
    public String getRunningVer(String nodeName) {
        ...
        try {
            NodeSoftwareGetResult = soapHelper_18_0.getStatusSoap()
                .nodeSoftwareStatusGet(nodeName, credentialsStatus);
            if (NodeSoftwareGetResult.getErrorCode() != Netspan.NBI_18_0.Status.ErrorCodes.OK) {
    ...
    public boolean delete3rdParty(ArrayList<String> names) {
        ...
        if (names.isEmpty() || names == null)
            return true;
        try {
            result = soapHelper_18_0.getLteSoap().lte3RdPartyDelete(names, credentialsLte);
            if (result.getErrorCode() != Netspan.NBI_18_0.Lte.ErrorCodes.OK) {
    ...
    public List<String> getAll3rdParty() {
        ...
        try {
            nameResult = soapHelper_18_0.getLteSoap().lte3RdPartyList(credentialsLte);
            if (nameResult.getErrorCode() != Netspan.NBI_18_0.Lte.ErrorCodes.OK) {
    ...
    public HashMap<ConnectedUETrafficDirection, HashMap<Integer, Integer>> getUeConnectedPerCategory(EnodeB enb) {
        Netspan.NBI_18_0.Status.LteUeGetResult lteUeGetResult;
        ...
        try {
            lteUeGetResult = soapHelper_18_0.getStatusSoap()
                .enbConnectedUeStatusGet(enb.getNetspanName(), credentialsStatus);
            if (lteUeGetResult.getErrorCode() != Netspan.NBI_18_0.Status.ErrorCodes.OK) {
                report.report("enbConnectedUeStatusGet via Netspan Failed : " + lteUeGetResult.getErrorString(),
                    Reporter.WARNING);
                return ret;
            }
            for (Netspan.NBI_18_0.Status.LteUeStatusWs currentCell : lteUeGetResult.getCell()) {
                if (currentCell.getCellId().getValue() == enb.getCellContextID()) {
                    List<Netspan.NBI_18_0.Status.LteUeCategory> catDataList = currentCell.getCategoryData();
                	ulData.clear();
                	dlData.clear();
                    for (Netspan.NBI_18_0.Status.LteUeCategory catData : catDataList) {
    ...
    public boolean verifyNoANRNeighbors(EnodeB enodeB) {
        ...
        try {
            lteSonAnrGetResult = soapHelper_18_0.getStatusSoap()
                .enbSonAnrStatusGet(enodeB.getNetspanName(), credentialsStatus);
            if (lteSonAnrGetResult.getErrorCode() != Netspan.NBI_18_0.Status.ErrorCodes.OK) {
    ...
    public boolean setNodeServiceState(EnodeB enb, EnbStates enbState) {
        Netspan.NBI_18_0.Lte.NodeActionResult result = null;
        try {
            result = soapHelper_18_0.getLteSoap()
    ...
    public boolean getNetworkProfileResult(String profileName, NetworkParameters np) {
        ...
        try {
            result = soapHelper_18_0.getLteSoap().networkProfileGet(profilesName,null,null,
                credentialsLte);
    ...
    public NodeInfo getNodeDetails(EnodeB enodeB) {
        ...
        try {
            result = soapHelper_18_0.getInventorySoap().nodeInfoGet(nodeListName,
    ...
    public List<RFStatus> getRFStatus(EnodeB enodeB) {
        ...
        try {
            rfStatusResult = soapHelper_18_0.getStatusSoap().enbRfStatusGet(enodeB.getNetspanName(),
                credentialsStatus);
        } catch (Exception e) {
        ...
        if (rfStatusResult.getErrorCode() != Netspan.NBI_18_0.Status.ErrorCodes.OK) {
    ...
    public PTPStatus getPTPStatus(EnodeB dut) {
        ...
        try {
            ptpStatus = soapHelper_18_0.getStatusSoap().nodePtpGet(dut.getNetspanName(),
                credentialsStatus);
        } catch (Exception e) {
        ...
        if (ptpStatus.getErrorCode() != Netspan.NBI_18_0.Status.ErrorCodes.OK) {
    ...
    public boolean deleteAllAlarmsNode(EnodeB dut) {
        ...
        try {
            alarmsList = soapHelper_18_0.getFaultManagementSoap().alarmListNode(argsNodeName, null,
            ...
            soapHelper_18_0.endFaultManagementSoap();
        }
    ...
    public List<AlarmInfo> getAllAlarmsNode(EnodeB dut) {
        ...
        if (alarmsList.getErrorCode() != Netspan.NBI_18_0.FaultManagement.ErrorCodes.OK) {
    ...
    public boolean deleteAlarmById(String alarmId) {
        ...
        try {
            ...
            deleteResult = soapHelper_18_0.getFaultManagementSoap().alarmDelete(argsAlarmId,
                credentialsFaultManagement);
            if (deleteResult.getErrorCode() != Netspan.NBI_18_0.FaultManagement.ErrorCodes.OK) {
    ...
    public List<EventInfo> getEventsNodeByDateRange(EnodeB dut, Date startTime, Date endTime) {
        ...
        try {
            ...
            events = soapHelper_18_0.getFaultManagementSoap().eventListNode(nodeNames, null, start,
        ...
        if (events.getErrorCode() != Netspan.NBI_18_0.FaultManagement.ErrorCodes.OK) {
    ...
    public boolean changeCurrentRadioProfileWithoutClone(EnodeB dut, RadioParameters rp) {
        ...
        try {
            ProfileResponse response = soapHelper_18_0.getLteSoap()
    ...
    public boolean checkCannotAddNeighbor(EnodeB enodeB, EnodeB neighbor, HoControlStateTypes hoControlStatus,
        ...
        if (enbNumbersOfCells == nbrNumbersOfCells && enbNumbersOfCells == 2) {
            ...
            try {
            	Netspan.NBI_18_0.Lte.HandoverTypes hoType = (handoverType == Netspan.API.Enums.HandoverType.S_1_ONLY) ? Netspan.NBI_18_0.Lte.HandoverTypes.S_1_ONLY :
            		Netspan.NBI_18_0.Lte.HandoverTypes.TRIGGER_X_2;
                for (int i = 1; i <= 3; i++) {
                    LteNeighbourResponse result = soapHelper_18_0.getLteSoap().lteNeighbourAdd(
                        sourceNodeName, neighborName, hoControlStatus, x2ControlStatus, hoType,
    ...
    public boolean addNeighbourMultiCell(EnodeB enodeB, EnodeB neighbor, HoControlStateTypes hoControlStatus,
        ...
        try {
            ...
            if (result.getLteNeighbourResult().get(0).getResultCode() != Netspan.NBI_18_0.Lte.LteNeighbourResultValues.OK) {
    ...
    private List<LteAnrStatusWs> getNeighbourList(EnodeB enb) {
        try {
            LteSonAnrGetResult result = soapHelper_18_0.getStatusSoap()
                .enbSonAnrStatusGet(enb.getNetspanName(), credentialsStatus);
            if (result.getErrorCode() != Netspan.NBI_18_0.Status.ErrorCodes.OK) {
    ...
    private LteSyncProfileResult getSyncProfile(EnodeB node) {
        ...
        try {
            returnObject = soapHelper_18_0.getLteSoap().syncProfileGet(profiles,null,null,
                credentialsLte);
        } catch (Exception e) {
        ...
        if (returnObject.getErrorCode() != Netspan.NBI_18_0.Lte.ErrorCodes.OK) {
    ...
    private EnbNetworkProfile networkProfileGet(String profileName) {
        ...
        try {
            LteNetworkProfileGetResult lteNetworkProfile = soapHelper_18_0.getLteSoap()
                .networkProfileGet(names, null,null,credentialsLte);
            if (lteNetworkProfile.getErrorCode() == Netspan.NBI_18_0.Lte.ErrorCodes.OK) {
    ...
    private Enb3RdParty get3rdParty(String... partiesArray) {
        ...
        try {
            Lte3RdPartyGetResult result = soapHelper_18_0.getLteSoap().lte3RdPartyGet(parties,
                credentialsLte);
            GeneralUtils.printToConsole(
                "NBI method \"Lte3rdPartyCreate\"  returned value: " + result.getErrorCode().toString());
            if (result.getErrorCode() != Netspan.NBI_18_0.Lte.ErrorCodes.OK) {
            ...
            if (result != null && result.getLte3RdPartyResult() != null && result.getLte3RdPartyResult().get(0)
                .getResultCode() == Netspan.NBI_18_0.Lte.Lte3RdPartyResultValues.OK)
    ...
    public boolean setEnbType(String nodeName, EnbTypes type) {
		...
		try {
			Netspan.NBI_18_0.Lte.NodeActionResult result = soapHelper_18_0.getLteSoap().enbConfigSet(nodeName, null,null,
    ...
    private EnbNetworkProfile getNetworkProfile(String profileName) {
		try {
			...
			a.add(profileName);
			result = soapHelper_18_0.getLteSoap().networkProfileGet(a, null,null,
					credentialsLte);
			if (result.getErrorCode() != Netspan.NBI_18_0.Lte.ErrorCodes.OK) {
				report.report("networkProfileGet via Netspan Failed : " + result.getErrorString(), Reporter.WARNING);
			}
    ...
    private boolean verifyReProvisionResponseRetries(String nodeName, int numOfRetries) {
		...
		Netspan.NBI_18_0.Inventory.NodeActionResult nodeReProvisionResult = soapHelper_18_0
				.getInventorySoap().nodeReprovision(nodeList, null, credentialsInventory);
		if (nodeReProvisionResult.getErrorCode() == Netspan.NBI_18_0.Inventory.ErrorCodes.OK) {
			report.report(String.format("%s - ReProvision started.", nodeName));
			for (int i = 0; i < numOfRetries; i++) {
				NodeProvisioningGetResult statusGetResult = soapHelper_18_0
    ...
    private boolean verifyActionsTableIsEmpty(boolean reProPass, Netspan.NBI_18_0.Inventory.NodeActionResult nodeReProvisionResult, NodeProvisioningGetResult statusGetResult) {
		if (statusGetResult.getErrorCode() == Netspan.NBI_18_0.Inventory.ErrorCodes.OK) {
    ...
    public boolean checkAndSetDefaultProfiles(EnodeB node, boolean setProfile) {
		...
		try {
			...
			for (CellNetspanProfiles cellProfiles : enbProfiles.cellProfiles) {
				...
				lteCellSet = checkForExistsCellProfileAndSet18_0(enbProfiles, lteCellSet, cellProfiles, CellProfiles.Cell_Advanced_Profile, setProfile);
				lteCellSet = checkForExistsCellProfileAndSet18_0(enbProfiles, lteCellSet, cellProfiles, CellProfiles.Radio_Profile, setProfile);
				lteCellSet = checkForExistsCellProfileAndSet18_0(enbProfiles, lteCellSet, cellProfiles, CellProfiles.Mobility_Profile, setProfile);
				lteCellSet = checkForExistsCellProfileAndSet18_0(enbProfiles, lteCellSet, cellProfiles, CellProfiles.Embms_Profile, setProfile);
				lteCellSet = checkForExistsCellProfileAndSet18_0(enbProfiles, lteCellSet, cellProfiles, CellProfiles.Traffic_Management_Profile, setProfile);
				lteCellSet = checkForExistsCellProfileAndSet18_0(enbProfiles, lteCellSet, cellProfiles, CellProfiles.Call_Trace_Profile, setProfile);
				enbConfigSet.getLteCell().add(lteCellSet);
				GeneralUtils.stopLevel();
			}
			GeneralUtils.startLevel("checking profiles for node : " + node.getNetspanName());
			enbConfigSet = checkForExistsNodeProfileAndSet18_0(enbProfiles, enbConfigSet, EnbProfiles.System_Default_Profile, setProfile);
			enbConfigSet = checkForExistsNodeProfileAndSet18_0(enbProfiles, enbConfigSet, EnbProfiles.EnodeB_Advanced_Profile, setProfile);
			enbConfigSet = checkForExistsNodeProfileAndSet18_0(enbProfiles, enbConfigSet, EnbProfiles.Network_Profile, setProfile);
			enbConfigSet = checkForExistsNodeProfileAndSet18_0(enbProfiles, enbConfigSet, EnbProfiles.Sync_Profile, setProfile);
			enbConfigSet = checkForExistsNodeProfileAndSet18_0(enbProfiles, enbConfigSet, EnbProfiles.Security_Profile, setProfile);
			enbConfigSet = checkForExistsNodeProfileAndSet18_0(enbProfiles, enbConfigSet, EnbProfiles.Son_Profile, setProfile);
			enbConfigSet = checkForExistsNodeProfileAndSet18_0(enbProfiles, enbConfigSet, EnbProfiles.Management_Profile, setProfile);
			enbConfigSet = checkForExistsNodeProfileAndSet18_0(enbProfiles, enbConfigSet, EnbProfiles.Neighbour_Management_Profile, setProfile);
			GeneralUtils.stopLevel();
    ...
    private LteCellSetWs checkForExistsCellProfileAndSet18_0(DefaultNetspanProfiles enbProfiles, LteCellSetWs lteCellSetWs, CellNetspanProfiles cellProfiles, CellProfiles profileType, boolean setProfile) {
		String profileName = cellProfiles.getProfile(profileType);
		if (profileName != null) {
			if (isProfileExists(profileName, profileType)) {
				if (setProfile) {
					lteCellSetWs = injectContentToWsCellObject18_0(lteCellSetWs, enbProfiles, cellProfiles, profileType);
				}
			} else
    ...
    private LteEnbDetailsSetWs checkForExistsNodeProfileAndSet18_0(DefaultNetspanProfiles enbProfiles, LteEnbDetailsSetWs enbConfigSet, EnbProfiles profileType, boolean setProfile) {
    ...
    private LteCellSetWs injectContentToWsCellObject18_0(LteCellSetWs lteCellSetWs, DefaultNetspanProfiles enbProfiles, CellNetspanProfiles cellProfiles, CellProfiles profileType) {
		switch (profileType) {
			case Cell_Advanced_Profile:
    ...
    public SONStatus getSONStatus(EnodeB dut) {
        ...
        try {
            sonPciStatus = soapHelper_18_0.getStatusSoap().enbSonPciStatusGet(dut.getNetspanName(),
                credentialsStatus);
            sonRsiStatus = soapHelper_18_0.getStatusSoap().enbSonRsiStatusGet(dut.getNetspanName(),
                credentialsStatus);
        } catch (Exception e) {
        ...
        if (sonPciStatus.getErrorCode() != Netspan.NBI_18_0.Status.ErrorCodes.OK) {
    ...
    public NeighborData getNeighborData(String nodeName, String nghName) {
    	LteSonAnrGetResult AnrResult = soapHelper_18_0.getStatusSoap().enbSonAnrStatusGet(nodeName,
				credentialsStatus);
    ...
    public boolean updateSonProfile(EnodeB node, String cloneFromName, SonParameters sonParams) {
    	try {
			...
			ProfileResponse updateResult = soapHelper_18_0.getLteSoap()
			...
			if (updateResult == null) {
				...
				return false;
			} else if (updateResult.getErrorCode() == Netspan.NBI_18_0.Lte.ErrorCodes.OK) {
    ...
    private SwServerWs CreateSoftwareServerObject(EnodeBUpgradeServer upgradeServer) {
        Netspan.NBI_18_0.Software.ObjectFactory objectFactory = new Netspan.NBI_18_0.Software.ObjectFactory();
    ...
    public boolean createSoftwareImage(EnodeBUpgradeImage upgradeImage) {
    	Netspan.NBI_18_0.Software.SwImageWs softwareImage = createSoftwareImageObject(upgradeImage);
		Netspan.NBI_18_0.Software.SwFileInfoWs softwareFileInfo = createFileInfoObject(upgradeImage);
		List<Netspan.NBI_18_0.Software.SwFileInfoWs> fileList = softwareImage.getSoftwareFileInfo();
		fileList.add(softwareFileInfo);

		Netspan.NBI_18_0.Software.SwImageResponse result = soapHelper_18_0
    ...
    private SwImageWs createSoftwareImageObject(EnodeBUpgradeImage upgradeImage) {
    	...
    	Netspan.NBI_18_0.Software.ObjectFactory factory = new Netspan.NBI_18_0.Software.ObjectFactory();
    ...
    public EnodeBUpgradeImage getSoftwareImage(String upgradeImagename) {
        ...
        if (result.getErrorCode() != Netspan.NBI_18_0.Software.ErrorCodes.OK) {
            ...
            Netspan.NBI_18_0.Software.SwImageWs imageResult = result.getSoftwareImageResult().get(0).getSoftwareImage();
    ...
    public HardwareCategory getHardwareCategory(EnodeB node) {
		...
		List<java.lang.String> enbList = new ArrayList<java.lang.String>();
		enbList.add(enbRadioProfileName);
		netspanResult = soapHelper_18_0.getLteSoap().radioProfileGet(enbList,null, null,credentialsLte);
		if (netspanResult.getErrorCode() != Netspan.NBI_18_0.Lte.ErrorCodes.OK) {
    ...
    public boolean softwareConfigSet(String nodeName, RequestType requestType, String softwareImageName) {
        Netspan.NBI_18_0.Software.SwConfigSetWs softwareDetails = createsoftwareDetails(requestType, softwareImageName);
        Netspan.NBI_18_0.Software.NodeActionResult result = soapHelper_18_0.getSoftwareSoap()
    ...
    private SwConfigSetWs createsoftwareDetails(RequestType requestType, String softwareImageName) {
        Netspan.NBI_18_0.Software.ObjectFactory objectFactory = new Netspan.NBI_18_0.Software.ObjectFactory();
        Netspan.NBI_18_0.Software.SwConfigSetWs softwareDetails = new Netspan.NBI_18_0.Software.SwConfigSetWs();
    ...
    public SoftwareStatus getSoftwareStatus(String nodeName, ImageType imageType) {
		...
		SoftwareStatusGetWs result = soapHelper_18_0.getSoftwareSoap().softwareStatusGet(enbList, credentialsSoftware);
		if (result.getErrorCode() != Netspan.NBI_18_0.Software.ErrorCodes.OK) {
    ...
    public int getDLTPTPerQci(String nodeName, int qci) {
    	LteIpThroughputGetResult result = soapHelper_18_0.getStatusSoap()
    ...
    public boolean getDicicUnmanagedInterferenceStatus(String nodeName, int nghPci) {
        report.report("getDicicUnmanagedInterferenceStatus via NBI_18_0 Failed : Try to use correct NBI version",
            Reporter.WARNING);
        return false;
    }
    ...
    private boolean getSystemDefaultProfile(EnodeB node, String cloneFromName) {
		...
		try {
			soapHelper_18_0.getLteSoap().systemDefaultProfileGet(names, hardwares,null, credentialsLte);
		} catch (Exception e) {
			e.printStackTrace();
			soapHelper_18_0.endLteSoap();
			return false;
    ...
    public boolean getManagementProfile(EnodeB node, String cloneFromName) {
        ...
        names.add(cloneFromName);
        try {
            soapHelper_18_0.getLteSoap().managementProfileGet(names,null,null, credentialsLte);
        } catch (Exception e) {
            soapHelper_18_0.endLteSoap();
            e.printStackTrace();
            return false;
    ...
    public boolean getSecurityProfile(EnodeB node, String cloneFromName) {
        ...
        names.add(cloneFromName);
        try {
            soapHelper_18_0.getLteSoap().securityProfileGet(names,null,null, credentialsLte);
        } catch (Exception e) {
            soapHelper_18_0.endLteSoap();
            e.printStackTrace();
            return false;
    ...
    public boolean getMobilityProfile(EnodeB node, String cloneFromName) {
        ...
        names.add(cloneFromName);
        try {
            soapHelper_18_0.getLteSoap().mobilityProfileGet(names,null,null, credentialsLte);
        } catch (Exception e) {
            soapHelper_18_0.endLteSoap();
            e.printStackTrace();
            return false;
    ...
    public boolean getNetworkProfile(EnodeB node, String cloneFromName) {
        ...
        names.add(cloneFromName);
        try {
            soapHelper_18_0.getLteSoap().networkProfileGet(names,null,null, credentialsLte);
        } catch (Exception e) {
            soapHelper_18_0.endLteSoap();
            e.printStackTrace();
            return false;
    ...
    public boolean getSonProfile(EnodeB node, String cloneFromName) {
        ...
        names.add(cloneFromName);
        try {
            soapHelper_18_0.getLteSoap().sonProfileGet(names,null,null, credentialsLte);
        } catch (Exception e) {
            soapHelper_18_0.endLteSoap();
            e.printStackTrace();
            return false;
    ...
    public boolean getRadioProfile(EnodeB node, String cloneFromName) {
        ...
        names.add(cloneFromName);
        try {
            soapHelper_18_0.getLteSoap().radioProfileGet(names,null,null, credentialsLte);
        } catch (Exception e) {
            soapHelper_18_0.endLteSoap();
            e.printStackTrace();
            return false;
    ...
    public boolean getSyncProfile(EnodeB node, String cloneFromName) {
        ...
        names.add(cloneFromName);
        try {
            soapHelper_18_0.getLteSoap().syncProfileGet(names,null,null, credentialsLte);
        } catch (Exception e) {
            soapHelper_18_0.endLteSoap();
            e.printStackTrace();
            return false;
    ...
    public boolean getAdvancedConfigurationProfile(EnodeB node, String cloneFromName) {
        ...
        names.add(cloneFromName);
        try {
            soapHelper_18_0.getLteSoap().cellAdvancedConfigProfileGet(names,null,null, credentialsLte);
        } catch (Exception e) {
            soapHelper_18_0.endLteSoap();
            e.printStackTrace();
            return false;
    ...
    public boolean getRawNetspanGetProfileResponse(EnodeB node, String cloneFromName, INetspanProfile profileParams) {
        ...
        soapHelper_18_0.clearRawData();
        switch (profileParams.getType()) {
            case System_Default_Profile:
                soapHelper_18_0.getLteSoapRaw().systemDefaultProfileGet(name,null,null, credentialsLte);
                break;
            case Management_Profile:
                soapHelper_18_0.getLteSoapRaw().managementProfileGet(name,null,null, credentialsLte);
                break;
            case Mobility_Profile:
                soapHelper_18_0.getLteSoapRaw().mobilityProfileGet(name,null,null, credentialsLte);
                break;
            case Network_Profile:
                soapHelper_18_0.getLteSoapRaw().networkProfileGet(name,null,null, credentialsLte);
                break;
            case Radio_Profile:
                soapHelper_18_0.getLteSoapRaw().radioProfileGet(name,null,null, credentialsLte);
                break;
            case Security_Profile:
                soapHelper_18_0.getLteSoapRaw().securityProfileGet(name,null,null, credentialsLte);
                break;
            case Son_Profile:
                soapHelper_18_0.getLteSoapRaw().sonProfileGet(name,null,null, credentialsLte);
                break;
            case Sync_Profile:
                soapHelper_18_0.getLteSoapRaw().syncProfileGet(name,null,null, credentialsLte);
                break;
            case EnodeB_Advanced_Profile:
                soapHelper_18_0.getLteSoapRaw().enbAdvancedConfigProfileGet(name,null,null, credentialsLte);
                break;
            case Cell_Advanced_Profile:
                soapHelper_18_0.getLteSoap().cellAdvancedConfigProfileGet(name,null,null, credentialsLte);
                break;
            case Neighbour_Management_Profile:
                report.report("Neighbour management profile does not exist in netspan 18_0");
                break;
            case MultiCell_Profile:
                soapHelper_18_0.getLteSoapRaw().multiCellProfileGet(name,null,null, credentialsLte);
                break;
            default:
                return false;
        }
        ...
        try {
            String rawData = soapHelper_18_0.getSOAPRawData();
    ...
    public boolean setLatitudeAndLongitude(EnodeB node, BigDecimal Latitude, BigDecimal Longitude) {
		...
		try{
			result = soapHelper_18_0.getInventorySoap().nodeLatitudeLongitudeSet(node.getNetspanName(), Latitude, Longitude, credentialsInventory);
			if(result.getErrorCode() != Netspan.NBI_18_0.Inventory.ErrorCodes.OK){
    ...
    public String getSyncState(EnodeB eNodeB) {
		...
		try {
			result = soapHelper_18_0.getStatusSoap().nodeGpsGet(eNodeB.getNetspanName(),
					credentialsStatus);
		} catch (Exception e) {
    ...
    public List<LteBackhaul> getBackhaulInterfaceStatus(EnodeB node) {
    	LteBackhaulIfGetResult serverResult = soapHelper_18_0.getStatusSoap().enbBackhaulInterfaceStatusGet(node.getNetspanName(), credentialsStatus);
    ...
    public boolean resetNode(String nodeName, RebootType rebootType) {
		...
		Netspan.NBI_18_0.Inventory.NodeActionResult result = null;
		if (rebootType == RebootType.WARM_REBOOT) {
			result = soapHelper_18_0.getInventorySoap().nodeReset(nodeList, null, false, credentialsInventory);
		} else {
			result = soapHelper_18_0.getInventorySoap().nodeResetCold(nodeList, null, credentialsInventory);
		}
		if (result != null) {
			if (result.getErrorCode() != Netspan.NBI_18_0.Inventory.ErrorCodes.OK) {
    ...
    public boolean setEnbAccessClassBarring(EnodeB dut, CellBarringPolicyParameters cellBarringParams) {
		...
		try {
			...
			enbConfigSet.getLteCell().add(lteCellSet);
			Netspan.NBI_18_0.Lte.NodeActionResult result = soapHelper_18_0.getLteSoap().enbConfigSet(dut.getNetspanName(),null, null, enbConfigSet, null, credentialsLte);
			if (result.getErrorCode() != Netspan.NBI_18_0.Lte.ErrorCodes.OK) {
				report.report("setEnbCellProperties via Netspan Failed : " + result.getErrorString(), Reporter.WARNING);
				return false;
			} else
    ...
    private SoftwareStatusGetWs getSoftwareStatusForEnb(EnodeB enodeB) {
        ...
        return soapHelper_18_0.getSoftwareSoap().softwareStatusGet(enbList, credentialsSoftware);
    }
    ...
    private NodeSoftwareStatus getSoftwareStatus(EnodeB enodeB) {
        ...
        if (!Netspan.NBI_18_0.Software.ErrorCodes.OK.equals(softwareStatusGetWs.getErrorCode())) {
            return null;
        }
    ...
    public String getImageType(String nodeName) {
        report.report("getImageType method is not implemented for this netspan(18_0)!");
        return null;
    }
    ...
    public int getMaxUeSupported(EnodeB enb) {
		...
		try {
			LteUeGetResult result = soapHelper_18_0.getStatusSoap().enbConnectedUeStatusGet(enb.getNetspanName(), credentialsStatus);
			if(result.getErrorCode() != Netspan.NBI_18_0.Status.ErrorCodes.OK){
	...
	public boolean resetNodeRebootAction(String nodeName, RebootTypesNetspan rebootType) {
		...
		if(rebootType == RebootTypesNetspan.Reset_Node){
			result = soapHelper_18_0.getInventorySoap().nodeReset(listEnb, null,false, credentialsInventory);
		}else if(rebootType == RebootTypesNetspan.Forced_Reset_Node){
			result = soapHelper_18_0.getInventorySoap().nodeResetForced(listEnb, null,false, credentialsInventory);
		}else if(rebootType == RebootTypesNetspan.Cold_Reset_Node){
			result = soapHelper_18_0.getInventorySoap().nodeResetCold(listEnb, null, credentialsInventory);
		}else{
			result = soapHelper_18_0.getInventorySoap().nodeResetForcedCold(listEnb, null, credentialsInventory);
		}
		boolean rebooted = result.getErrorCode() == Netspan.NBI_18_0.Inventory.ErrorCodes.OK;
		soapHelper_18_0.endInventorySoap();
		return rebooted;
	}
	...
	public boolean relayScan(EnodeB enodeB, RelayScanType scanType) {
		Netspan.NBI_18_0.Backhaul.NodeActionResult result = null;
		ArrayList<String> listEnb = new ArrayList<String>();
		listEnb.add(enodeB.getNetspanName());
		boolean scanned = false;
		try{
			if(scanType == RelayScanType.ForceScan){
				result = soapHelper_18_0.getBackhaulSoap().relayForceScan(listEnb, null, credentialsBackhaul);
				scanned = result.getErrorCode() == Netspan.NBI_18_0.Backhaul.ErrorCodes.OK;
				if(!scanned){
					report.report("Scan failed due to: "+result.getNode().get(0).getNodeResultString(),Reporter.WARNING);
				}
			}else{
				result = soapHelper_18_0.getBackhaulSoap().relayScan(listEnb, null, credentialsBackhaul);
				scanned = result.getErrorCode() == Netspan.NBI_18_0.Backhaul.ErrorCodes.OK;
				if(!scanned){
					report.report("Scan failed due to: "+result.getNode().get(0).getNodeResultString(),Reporter.WARNING);
				}
			...
			soapHelper_18_0.endBackhaulSoap();			
		}
		return scanned;
	}
	...
	public boolean isRelayEnodeb(String nodeName) {
		try {
			...
			RelayEnodeBConfigGetResult result = soapHelper_18_0.getLteSoap().relayEnbConfigGet(nameList,null, credentialsLte);
			if (result.getErrorCode() == Netspan.NBI_18_0.Lte.ErrorCodes.OK) {
	...
	public boolean getMultiCellProfile(EnodeB node, String cloneFromName) {
		...
		names.add(cloneFromName);
		try {
			soapHelper_18_0.getLteSoap().multiCellProfileGet(names, hardwares,null, credentialsLte);
		} catch (Exception e) {
			e.printStackTrace();
			soapHelper_18_0.endLteSoap();
			return false;
	...
	public boolean getNeighborManagementProfile(EnodeB node, String cloneFromName) {
		...
		names.add(cloneFromName);
		try {
			soapHelper_18_0.getLteSoap().neighbourProfileGet(names, hardwares,null, credentialsLte);
		} catch (Exception e) {
			e.printStackTrace();
			soapHelper_18_0.endLteSoap();
			return false;
	...
	public boolean isFileServerExists(String fileServerName) {
		try {
			...
			result = soapHelper_18_0.getServerSoap().fileServerGet(nameList, credentialsServer);
			if (result.getErrorCode() != Netspan.NBI_18_0.Server.ErrorCodes.OK) {
	...
	public boolean createFileServer(FileServer fileServer) {
		Netspan.NBI_18_0.Server.ObjectFactory objectFactory = new Netspan.NBI_18_0.Server.ObjectFactory();
		...
		try {
			FileServerResponse result = null;
			result = soapHelper_18_0.getServerSoap().fileServerCreate(fileServerWs,
					credentialsServer);
			if (result.getErrorCode() != Netspan.NBI_18_0.Server.ErrorCodes.OK) {
	...
	public MultiCellParameters getMultiCellProfileObject(EnodeB node, String profileName) {
		...
		MultiCellProfileGetResult multiCellNetspan = soapHelper_18_0.getLteSoap().multiCellProfileGet(name, categoryList,null, credentialsLte);
	...
	public HashMap<String, NetworkElementStatus> getMMEStatuses(EnodeB enb) {
		...
		LteNetworkElementGetResult result = soapHelper_18_0.getStatusSoap().enbNetworkElementStatusGet(enb.getNetspanName(), credentialsStatus);
		if (result != null) {
