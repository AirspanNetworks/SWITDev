...
import Netspan.NBI_18_0.Backhaul.Backhaul;
import Netspan.NBI_18_0.Backhaul.BackhaulSoap;
import Netspan.NBI_18_0.FaultManagement.FaultManagement;
import Netspan.NBI_18_0.FaultManagement.FaultManagementSoap;
import Netspan.NBI_18_0.Inventory.Inventory;
import Netspan.NBI_18_0.Inventory.InventorySoap;
import Netspan.NBI_18_0.Lte.Lte;
import Netspan.NBI_18_0.Lte.LteSoap;
import Netspan.NBI_18_0.Server.Server;
import Netspan.NBI_18_0.Server.ServerSoap;
import Netspan.NBI_18_0.Software.Software;
import Netspan.NBI_18_0.Software.SoftwareSoap;
import Netspan.NBI_18_0.Statistics.Statistics;
import Netspan.NBI_18_0.Statistics.StatisticsSoap;
import Netspan.NBI_18_0.Status.Status;
import Netspan.NBI_18_0.Status.StatusSoap;
...
public class SoapHelper {
    ...
    private static final String WS_VERSION = "18.0";
	...
	public SoapHelper(String hostName) throws Exception {
		...
		wsdl_URL_FAULTMANAGEMENT = new URL("https://" + hostName + "/ws/" + WS_VERSION + "/FaultManagement.asmx?WSDL");
		wsdl_URL_INVENTORY = new URL("https://" + hostName + "/ws/" + WS_VERSION + "/Inventory.asmx?WSDL");
		wsdl_URL_LTE = new URL("https://" + hostName + "/ws/" + WS_VERSION + "/Lte.asmx?WSDL");
		wsdl_URL_SERVER = new URL("https://" + hostName + "/ws/" + WS_VERSION + "/Server.asmx?WSDL");
		wsdl_URL_STATISTICS = new URL("https://" + hostName + "/ws/" + WS_VERSION + "/Statistics.asmx?WSDL");
		wsdl_URL_STATUS = new URL("https://" + hostName + "/ws/" + WS_VERSION + "/Status.asmx?WSDL");
		wsdl_URL_BACKHAUL = new URL("https://" + hostName + "/ws/" + WS_VERSION + "/Backhaul.asmx?WSDL");
		wsdl_URL_SOFTWARE = new URL("https://" + hostName + "/ws/" + WS_VERSION + "/Software.asmx?WSDL");
