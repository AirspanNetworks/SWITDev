...
public class Traffic {
    ...
    private Boolean checkSTCCurrentParams() throws Exception {
        boolean nullCheck = generatorResults == null || analyzerResults == null || txStreamResults == null || rxStreamResults == null;
        boolean zeroSizeCheck = generatorResults.getNames().size() == 0 || analyzerResults.getNames().size() == 0 ||
                txStreamResults.getNames().size() == 0 || rxStreamResults.getNames().size() == 0;
        return !zeroSizeCheck && !nullCheck;
    }
    ...
    public boolean isTrafficItraffic() {
        return generatorType == TrafficGeneratorType.ITraffic;
    }
