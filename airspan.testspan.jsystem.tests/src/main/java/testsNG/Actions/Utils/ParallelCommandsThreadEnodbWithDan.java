...
public class ParallelCommandsThreadEnodbWithDan extends ParallelCommandsThreadEnodeBComponent {
    ...
    public ParallelCommandsThreadEnodbWithDan(List<String> enodebCmdSet, EnodeBWithDAN enbWithDan, List<String> danCmdSet, int responseTimeout, int waitBetweenCommands) throws IOException {
        super(enodebCmdSet, enbWithDan, enbWithDan.getXLPName(), responseTimeout, waitBetweenCommands);
        ...
        for (int i = 0; i < danSyncCommands.length; i++) {
            danSyncCommands[i] = new ParallelCommandsThreadEnodeBComponent(danCmdSet, enbWithDan, enbWithDan.getDanName(i), responseTimeout, waitBetweenCommands);
        }
    }
