...
public class TPTBase extends TestspanTest {
	...
	protected void compareResultsWithCalculator(StreamList debugPrinter, Long uLrxTotal, Long dlrxTotal,
		...
		double ul_Divided_With_Number_Of_Streams = uLrxTotal / 1000000.0 / (ulStreamsNum/ueNameListStc.size());
		double dl_Divided_With_Number_Of_Streams = dlrxTotal / 1000000.0 / (dlStreamsNum/ueNameListStc.size());
