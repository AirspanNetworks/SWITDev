...
public class NeighborConf {
	 ...
	 * 0 - HoControlStateTypes.ALLOWED, X2ControlStateTypes.AUTOMATIC,HandoverType.TRIGGER_X_2, static
	 * 1 - HoControlStateTypes.ALLOWED, X2ControlStateTypes.AUTOMATIC,HandoverType.S_1_ONLY, static
	 * 2 - HoControlStateTypes.ALLOWED, X2ControlStateTypes.NOT_ALLOWED,HandoverType.S_1_ONLY, static
	 * 3 - HoControlStateTypes.PROHIBITED, X2ControlStateTypes.AUTOMATIC,HandoverType.TRIGGER_X_2, static
	 * 4 - HoControlStateTypes.PROHIBITED, X2ControlStateTypes.NOT_ALLOWED,HandoverType.TRIGGER_X_2, static
