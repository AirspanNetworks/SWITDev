...
public class P0 extends OtdoaBase {
	...
	@Test
	@TestProperties(name = "lppa_Message_Cell1=Disable_Cell2=Enable", returnParam = { "IsTestWasSuccessful" }, paramsExclude = {
			"IsTestWasSuccessful" })
	...
	@Test
	@TestProperties(name = "lppa Message Cell1=Enable Cell2=Disable", returnParam = { "IsTestWasSuccessful" }, paramsExclude = {
			"IsTestWasSuccessful" })
	...
	@Test
	@TestProperties(name = "lppa Message Cell1=Disable Cell2=Disable", returnParam = { "IsTestWasSuccessful" }, paramsExclude = {
			"IsTestWasSuccessful" })
	...
	@Test
	@TestProperties(name = "lppa Message via IPG and netspan Request Counter", returnParam = { "IsTestWasSuccessful" }, paramsExclude = {"DUT2",
			"IsTestWasSuccessful" })
	...
	@Test
	@TestProperties(name = "lppa Message via IPG and netspan Response Counter", returnParam = { "IsTestWasSuccessful" }, paramsExclude = {"DUT2",
			"IsTestWasSuccessful" })
	...
	@Test
	@TestProperties(name = "ue meas Cli Command and Verify Counter - OtdoaRrcConnectionReconfigStart", returnParam = { "IsTestWasSuccessful" }, paramsExclude = {"DUT2",
			"IsTestWasSuccessful" })
	...
	@Test
	@TestProperties(name = "ue meas Cli Command and Verify Counter - OtdoaRrcConnectionReconfigStop", returnParam = { "IsTestWasSuccessful" }, paramsExclude = {"DUT2",
			"IsTestWasSuccessful" })
	...
	@Test
	@TestProperties(name = "basic NMS Radio Verification :E-CID Enable, OTODA Enable", returnParam = { "IsTestWasSuccessful" }, paramsExclude = {
			"IsTestWasSuccessful" })
	...
	@Test
	@TestProperties(name = "basic NMS Radio Verification : E-CID Enable ,OTODA Disable", returnParam = { "IsTestWasSuccessful" }, paramsExclude = {
			"IsTestWasSuccessful" })
	...
	@Test
	@TestProperties(name = "basic NMS Radio Verification :E-CID Disable, OTDOA Enable", returnParam = { "IsTestWasSuccessful" }, paramsExclude = {
			"IsTestWasSuccessful" })
	public void basic_NMS_Radio_Verification_ECID_Disable_OTDOA_Enable(){
		...
		//ECID,timer,otdoa,subframes,bandWidth,prs Periodicity,offSet, power,Muting Periodicity ,pattern,isFDD,FrameConfig
	...
	@Test
	@TestProperties(name = "basic NMS Radio Verification :E-CID Disable, OTDOA Disable", returnParam = { "IsTestWasSuccessful" }, paramsExclude = {
			"IsTestWasSuccessful" })
	...
	//NOT TESTED YET!
	@TestProperties(name = "test12 - NMS Radio Configuration 1 FDD Mode", returnParam = { "IsTestWasSuccessful" }, paramsExclude = {
			"IsTestWasSuccessful" })
	public void test12_NMS_FDD_config1(){
		...
		//      ECID,timer,otdoa,subframes,bandWidth      ,prs Periodicity     ,offSet, power,Muting Periodicity ,pattern,isFDD,FrameConfig
		setRadioWithNetspan(dut,true,1000,true,"4",PRSBandWidthEnum.HUNDRED,PRSPeriodiclyEnum.ONE_HUNDRED_SIXTY,0,9000,PRSMutingPeriodiclyEnum.SIXTEE,"1111111111111111",true,null,null);
		//check with SNMP.
		if(!verifyOTDOAAndECIDWithSNMP(true,1000,true,4,"100","160",0,9000,"16","1111111111111111")){
			report.report("snmp Results were no match for excpectations",Reporter.FAIL);
		}else{
			report.report("snmp Results were Correct!");
		}	
	...
	@TestProperties(name = "test13 - NMS Radio Configuration 2 FDD Mode", returnParam = { "IsTestWasSuccessful" }, paramsExclude = {
			"IsTestWasSuccessful" })
	public void test13_NMS_FDD_config2(){
		...
		//      ECID,timer,otdoa,subframes,bandWidth      ,prs Periodicity     ,offSet, power,Muting Periodicity ,pattern,isFDD,FrameConfig 
		setRadioWithNetspan(dut,true,1000,true,"1,2,3,4",PRSBandWidthEnum.FIFTEEN,PRSPeriodiclyEnum.THREE_HUNDRED_TWENTY,10,0,PRSMutingPeriodiclyEnum.SIXTEE,"1111111100000000",true,null,null);
		//check with SNMP.
		if(!verifyOTDOAAndECIDWithSNMP(true,1000,true,4,prsBw.toString(),prsPeriod.toString(),10,0,mutePriod.toString(),"1111111100000000")){
			report.report("snmp Results were no match for excpectations",Reporter.FAIL);
		}else{
			report.report("snmp Results were Correct!");
		}	
	...
	@TestProperties(name = "test14 - NMS Radio Configuration 3 FDD Mode", returnParam = { "IsTestWasSuccessful" }, paramsExclude = {
			"IsTestWasSuccessful" })
	public void test14_NMS_FDD_config3(){
		...
		//      ECID,timer,otdoa,subframes,bandWidth      ,prs Periodicity     ,offSet, power,Muting Periodicity ,pattern,isFDD,FrameConfig 
		setRadioWithNetspan(dut,true,1000,true,"6,7,8,9",PRSBandWidthEnum.SIX,PRSPeriodiclyEnum.ONE_THOUSEND_TWO_HUNDRED_EIGHTY,100,10000,PRSMutingPeriodiclyEnum.TWO,"10",true,null,null);
		//check with SNMP.
		if(!verifyOTDOAAndECIDWithSNMP(true,1000,true,9,prsBw.toString(),prsPeriod.toString(),100,10000,mutePriod.toString(),"10")){
			report.report("snmp Results were no match for excpectations",Reporter.FAIL);
		}else{
			report.report("snmp Results were Correct!");
		}	
	...
	@TestProperties(name = "test15 - NMS Radio Configuration 1 TDD Mode FC 1", returnParam = { "IsTestWasSuccessful" }, paramsExclude = {
			"IsTestWasSuccessful" })
	public void test15_NMS_TDD_config1(){
		...
		//                      ECID,timer,otdoa,subframes,bandWidth      ,prs Periodicity     ,offSet, power,Muting Periodicity ,pattern,isFDD,FrameConfig 
		setRadioWithNetspan(dut,true,1000 ,true ,"9"     ,PRSBandWidthEnum.HUNDRED,PRSPeriodiclyEnum.ONE_HUNDRED_SIXTY,100   ,9000 ,PRSMutingPeriodiclyEnum.SIXTEE,"1111111111111111"  ,false,1,null);
		//check with SNMP.
		if(!verifyOTDOAAndECIDWithSNMP(true,1000,true,9,prsBw.toString(),prsPeriod.toString(),100,9000,mutePriod.toString(),"1111111111111111")){
			report.report("snmp Results were no match for excpectations",Reporter.FAIL);
		}else{
			report.report("snmp Results were Correct!");
		}	
	...
	@TestProperties(name = "test16 - NMS Radio Configuration 2 TDD Mode FC 2", returnParam = { "IsTestWasSuccessful" }, paramsExclude = {
			"IsTestWasSuccessful" })
	public void test16_NMS_TDD_config2(){
		...
		PRSPeriodiclyEnum prsPeriod = PRSPeriodiclyEnum.THREE_HUNDRED_TWENTY;
		//                      ECID,timer,otdoa,subframes,bandWidth      ,prs Periodicity     ,offSet, power,Muting Periodicity ,pattern,isFDD,FrameConfig 
		setRadioWithNetspan(dut,true,1000 ,true ,"3,4"     ,PRSBandWidthEnum.SEVENTY_FIVE,PRSPeriodiclyEnum.THREE_HUNDRED_TWENTY,200   ,5000 ,PRSMutingPeriodiclyEnum.EIGHT,"11111111"  ,false,2,null);
		//check with SNMP.
		if(!verifyOTDOAAndECIDWithSNMP(true,1000,true,4,prsBw.toString(),prsPeriod.toString(),200,5000,mutePriod.toString(),"11111111")){
			report.report("snmp Results were no match for excpectations",Reporter.FAIL);
		}else{
			report.report("snmp Results were Correct!");
		}	
	...
	@TestProperties(name = "test17 - NMS Radio Configuration 3 TDD Mode FC 2", returnParam = { "IsTestWasSuccessful" }, paramsExclude = {
			"IsTestWasSuccessful" })
	public void test17_NMS_TDD_config3(){
		...
		//                      ECID,timer,otdoa,subframes,bandWidth      ,prs Periodicity     ,offSet, power,Muting Periodicity ,pattern,isFDD,FrameConfig 
		setRadioWithNetspan(dut,true,1000 ,true ,"8,9"     ,PRSBandWidthEnum.FIFTEEN,PRSPeriodiclyEnum.SIX_HUNDRED_FORTY,400   ,3000 ,PRSMutingPeriodiclyEnum.FOUR,"1100"  ,false,2,null);
		//check with SNMP.
		if(!verifyOTDOAAndECIDWithSNMP(true,1000,true,9,prsBw.toString(),prsPeriod.toString(),400,3000,mutePriod.toString(),"1100")){
			report.report("snmp Results were no match for excpectations",Reporter.FAIL);
		}else{
			report.report("snmp Results were Correct!");
		}	
	...
	@TestProperties(name = "test18 - NMS Radio Configuration 1 TDD Mode FC 2,Negative", returnParam = { "IsTestWasSuccessful" }, paramsExclude = {
			"IsTestWasSuccessful" })
	public void test18_NMS_TDD_config2(){
		...
		//                      ECID,timer,otdoa,subframes,bandWidth      ,prs Periodicity     ,offSet, power,Muting Periodicity ,pattern,isFDD,FrameConfig 
		if(!setRadioWithNetspan(dut,true,1000 ,true ,"3,9"     ,PRSBandWidthEnum.FIFTEEN,PRSPeriodiclyEnum.SIX_HUNDRED_FORTY,400   ,3000 ,PRSMutingPeriodiclyEnum.FOUR,"1100"  ,false,2,null)){
	...
	@TestProperties(name = "test19 - NMS Radio Configuration 2 TDD Mode CellBandWitdh 5,Negative", returnParam = { "IsTestWasSuccessful" }, paramsExclude = {
			"IsTestWasSuccessful" })
	public void test19_NMS_TDD_config2(){
		...
		//                      ECID,timer,otdoa,subframes,bandWidth      ,prs Periodicity     ,offSet, power,Muting Periodicity ,pattern,isFDD,FrameConfig 
		if(!setRadioWithNetspan(dut,true,1000 ,true ,"8,9"     ,PRSBandWidthEnum.FIFTEEN,PRSPeriodiclyEnum.SIX_HUNDRED_FORTY,400   ,3000 ,PRSMutingPeriodiclyEnum.FOUR,"1100"  ,false,2,"5")){
			report.report("netspan Could not Clone Profile as expected!");
		}else{
			report.report("Netspan received clone profile!",Reporter.FAIL);
		}
	...
	@TestProperties(name = "test20 - NMS Radio Configuration 3 TDD Mode FC 2,Negative", returnParam = { "IsTestWasSuccessful" }, paramsExclude = {
			"IsTestWasSuccessful" })
	public void test20_NMS_TDD_config3(){
		...
		//                      ECID,timer,otdoa,subframes,bandWidth      ,prs Periodicity     ,offSet, power,Muting Periodicity ,pattern,isFDD,FrameConfig 
		if(!setRadioWithNetspan(dut,true,1000 ,true ,"8,9"     ,PRSBandWidthEnum.HUNDRED,PRSPeriodiclyEnum.SIX_HUNDRED_FORTY,400   ,3000 ,PRSMutingPeriodiclyEnum.FOUR,"11100"  ,false,2,null)){
			report.report("netspan Could not Clone Profile as expected!");
		}else{
			report.report("Netspan received clone profile!",Reporter.FAIL);
		}
	...
	@TestProperties(name = "test21 - NMS Radio Configuration 1 FDD ,Negative", returnParam = { "IsTestWasSuccessful" }, paramsExclude = {
			"IsTestWasSuccessful" })
	public void test21_NMS_FDD_config1(){
		...
		//                      ECID,timer,otdoa,subframes,bandWidth      ,prs Periodicity     ,offSet, power,Muting Periodicity ,pattern,isFDD,FrameConfig 
		if(!setRadioWithNetspan(dut,true,1000 ,true ,"3"     ,PRSBandWidthEnum.HUNDRED,PRSPeriodiclyEnum.ONE_THOUSEND_TWO_HUNDRED_EIGHTY,0   ,3000 ,PRSMutingPeriodiclyEnum.SIXTEE,"1111111100000000"  ,true,null,null)){
			report.report("netspan Could not Clone Profile as expected!");
		}else{
			report.report("Netspan received clone profile!",Reporter.FAIL);
		}
