...
>>>>>>> refs/heads/moran
	...
	public void SharedENB_UEattachingFunctionalTest_TwoUEsDifferentPLMN() {
		...
		if (currentMME == null){
			...
			report.report("MME Found: " + currentMME.getS1IpAddress()+ " PLMN1: " + currentMME.getPLMNs().get(0) + " PLMN2: "+ currentMME.getPLMNs().get(1));
		if(otherMME == null){
	...
	private boolean setS1AndPLMN(EnodeB dut, MME currentMME, ArrayList<Plmn> plmnList){
		...
		np.setMMEIP(currentMME.getS1IpAddress());
